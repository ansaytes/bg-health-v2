    ...
    <div className="dashboard">
      ...
      <div className="dashboard-top-bar">
        ...
        <div className="mcu-total-bar">
          ...
          <span style={{ color: '#00B894', fontWeight: 700 }}>Valid: 0</span>
          <span style={{ color: '#FF4444', fontWeight: 700 }}>Expired: 0</span>
          <span style={{ color: '#555', fontWeight: 700 }}>No Data: 0</span>
