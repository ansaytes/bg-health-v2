    ...
    <div className="dashboard scrollable" ref={containerRef} style={{ position: 'relative', height: '100%' }}>
      ...
      <div className="kunjungan-scroll-content">
        ...
        <div className="kunjungan-trend-row">
          <div className="card glow-orange" style={{ padding: '10px 12px', flex: '1', display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="card glow-amber" style={{ padding: '10px 12px', flex: '1', display: 'flex', flexDirection: 'column' }}>
            <div className="card-head" style={{ marginBottom: 3 }}>
        ...
        <div className="kunjungan-row-charts">
          <div className="card glow-coral" style={{ padding: '10px 12px', flex: '1', display: 'flex', flexDirection: 'column' }}>
            <div className="card-head" style={{ marginBottom: 3 }}>
          ...
          <div className="card glow-teal" style={{ padding: '10px 12px', flex: '1', display: 'flex', flexDirection: 'column' }}>
            <div className="card-head" style={{ marginBottom: 3 }}>
          ...
          <div className="card glow-steel" style={{ padding: '10px 12px', flex: '1', display: 'flex', flexDirection: 'column' }}>
            <div className="card-head" style={{ marginBottom: 3 }}>
